...
//	echo var_dump($saved);
	...
	$pdf->SetTitle('Saved Slides');
	$pdf->SetSubject('NCLC Slides');
	...
	foreach( $saved as $slide ) {
		// 280 x 216
		$imageFile = 'http://images.peabody.yale.edu/nclc/' . $slide . '.jpg';
...
//		$pdf->AddPage();
	...
	$pdf->Output('saved_slides.pdf', 'I');


	
} else {
	
	echo ("no saved slides.");
